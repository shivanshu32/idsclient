...
const Seasson5 = () => {
  ...
  return (
    ...
    {/* test starts */}
           ...
           <Card title="Day 1 | All Shows" dateis="8th November 2024 | Friday | 6:00pm to 9:00pm" onOpen={openModel} showid="shw1" showprice="999" backg={passback} />
            {/* Card code block end */}
          ...
          <Card title="Day 2 | Single Show" dateis="9th November 2024 | Saturday | 6:00pm to 6:30pm" onOpen={openModel} showid="shw4" showprice="599"  backg={passback} />
           ...
           <Card title="General Pass | Whole Event" dateis="8th-9th November 2024 | All Day" onOpen={openModel} showid="shw8" showprice="3999"  backg={passback}  />
