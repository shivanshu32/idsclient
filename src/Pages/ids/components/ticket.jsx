...
export default function Ticket(props) {
    ...
    const thisurl = "https://www.indiadesignershow.com?ticketid=" + props.doc1.finalpassid

    const returnshowname = (showid) => {
                      ...
                      else if(showid == "shw6")
                            {
                      ...
                      else if(showid == "shw7")
                                {
                            ...
                            else if(showid == "shw8")
                                    {
                                        ...
                                        {
                                            return "November 8th-9th 2024 | VIP PASS"
                                        }
  ...
  //const showid = props.doc1.finalshowid
...
<div className="flex items-center justify-center">
    ...
    <span className="text-xs text-white font-normal">{props.doc1.finalpassid}</span>
    </div>
    </div>
                    ...
                    <div className="flex justify-center items-center mt-8 ">
                    <p className="text-white">*Term & Condition Apply</p>
                    </div>
